...
<div class="center-align" style="margin-top: 40px;">
	...
	<form method="post" action="femaleRegist">
	<div class="card-panel hoverable" style="width: 300px;height: 540px;margin-left: 39%;">
		<h4 class="flow-text" style="color: #e00683;">Girl</h4>
		<div class="row">
		...
		<div class="row">
			...
			<i class="material-icons prefix">lock_outline</i>
				...
				name="password" class="validate" required data-length="12" required minlength="6"　maxlength="12"/>
		...
		<input type="text" value="female" name="gender" style="visibility: hidden;">
	</div>
